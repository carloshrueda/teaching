...
public class InterrrupcionHilos01 {
...
class MyRunnable implements Runnable {
    ...
    public void run() {
        ...
        while (counter < 5) { // Se detendrá después de 5 iteraciones
            ...
            try {
                ...
                System.err.println("Hilo interrumpido: " + Thread.currentThread().getName());
    ...
    private void doSomethingUseful(int iteration) {
        System.out.println("Ejecutando tarea útil en iteración: " + iteration);
    }
}
